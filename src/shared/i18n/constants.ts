  ...
  return [
    {
      ...
      more: i18n.PAGES.COURTS.MOBILE_COURT.ROUTE.LABEL,
      image: {
    ...
    {
      title: i18n.PAGES.COURTS.FLOW_COURT.TITLE,
      description: i18n.PAGES.COURTS.FLOW_COURT.LITTLE_DESCRIPTION,
      url: i18n.PAGES.COURTS.FLOW_COURT.ROUTE.URL,
      label: i18n.PAGES.COURTS.FLOW_COURT.ROUTE.LABEL,
      more: i18n.PAGES.COURTS.FLOW_COURT.ROUTE.LABEL,
      image: {
        src: i18n.PAGES.COURTS.FLOW_COURT.CONTACT_SECTION.IMAGE,
        alt: i18n.PAGES.COURTS.FLOW_COURT.NAME,
      }
    },
    {
      ...
      more: i18n.PAGES.COURTS.PANORAMIC_COURT.ROUTE.LABEL,
      image: {
    ...
    },
    {
      ...
      more: i18n.PAGES.COURTS.CLUB_COURT.ROUTE.LABEL,
      image: {
    ...
    },
    {
      ...
      more: i18n.PAGES.COURTS.CLUB_PLUS_COURT.ROUTE.LABEL,
      image: {
    ...
    {
      title: i18n.PAGES.COURTS.CLUB_FORCE_80_COURT.TITLE,
      description: i18n.PAGES.COURTS.CLUB_FORCE_80_COURT.LITTLE_DESCRIPTION,
      url: i18n.PAGES.COURTS.CLUB_FORCE_80_COURT.ROUTE.URL,
      label: i18n.PAGES.COURTS.CLUB_FORCE_80_COURT.ROUTE.LABEL,
      more: i18n.PAGES.COURTS.CLUB_FORCE_80_COURT.ROUTE.LABEL,
      image: {
        src: i18n.PAGES.COURTS.CLUB_FORCE_80_COURT.CONTACT_SECTION.IMAGE,
        alt: i18n.PAGES.COURTS.CLUB_FORCE_80_COURT.NAME,
      }
    },
    {
      title: i18n.PAGES.COURTS.PANORAMIC_FORCE_80_COURT.TITLE,
      description: i18n.PAGES.COURTS.PANORAMIC_FORCE_80_COURT.LITTLE_DESCRIPTION,
      url: i18n.PAGES.COURTS.PANORAMIC_FORCE_80_COURT.ROUTE.URL,
      label: i18n.PAGES.COURTS.PANORAMIC_FORCE_80_COURT.ROUTE.LABEL,
      more: i18n.PAGES.COURTS.PANORAMIC_FORCE_80_COURT.ROUTE.LABEL,
      image: {
        src: i18n.PAGES.COURTS.PANORAMIC_FORCE_80_COURT.CONTACT_SECTION.IMAGE,
        alt: i18n.PAGES.COURTS.PANORAMIC_FORCE_80_COURT.NAME,
      }
    },
    {
      ...
      more: i18n.PAGES.COURTS.SINGLE_COURT.ROUTE.LABEL,
      image: {
    ...
    },
    {
      ...
      more: i18n.PAGES.COURTS.MINI_COURT.ROUTE.LABEL,
      image: {
